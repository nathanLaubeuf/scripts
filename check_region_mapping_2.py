...
if __name__ == '__main__':
    ...
    vert = loadtxt(sys.argv[1]) #_vertices_low.txt
    trian = loadtxt(sys.argv[2]) #_triangles_low.txt
    texture_file = sys.argv[3]
    texture = loadtxt(texture_file) #_region_mapping_low.txt
